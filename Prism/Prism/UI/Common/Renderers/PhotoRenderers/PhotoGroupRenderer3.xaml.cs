...
{
    public sealed partial class PhotoGroupRenderer3 : PhotoGroupRendererBase
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        protected override void OnPhotoGroupChanged()
        {
            ...
            Renderer3.StreamContext = PhotoGroupSource.StreamContext;
            Renderer3.UserId = PhotoGroupSource.UserId;
            Renderer3.UserName = PhotoGroupSource.UserName;
